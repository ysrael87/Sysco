...
public class Scenario1 {
	...
	public void scenarioOne() {
		...
		driver.findElement(By.className("search-keyword")).sendKeys("Lead Automation Test Developer");
